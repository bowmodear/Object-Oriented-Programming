...
int main(){
    ...
    std::cout<<"Number of cars is " << c3.getCarsCount()<<"\n";
    Car c4;
    std::cout<<"Number of cars is " << c4.getCarsCount()<<"\n";
    myCar.setMaker("BMW");
    myCar.setModel(2009);
    ...
    Distance d1,d2(11,6.25f),d3(d2),d4(5,3.25f);
    std::cout<<"Distance 1 is "<< d1.print() <<"\nDistance 2 is "<<d2.print() <<"\nDistance 3 is "<<d3.print() <<"\nDistance 4 is "<<d4.print()<<endl;
    Distance d5 = d2.addDistance(d4);
    std::cout<<d5.print() <<endl;
    std::cout<<calc::add(5,9) << "\t" << calc::mult(8,9)<<"\t"<<calc::sub(10,19)<<endl; 
}